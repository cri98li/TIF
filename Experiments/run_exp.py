...
if __name__ == "__main__":
    ...
    pbar_dataset = tqdm(datasets, position=1, leave=False)
    for dataset in pbar_dataset:
        ...
        par = list(itertools.product(*parameters))
        ...
        result_all = []
        for els, (time, y_pred) in zip(itertools.product(*parameters), els_bar):
